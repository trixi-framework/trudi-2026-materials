...
@inline function Trixi.boundary_condition_slip_wall(
    ...
    t,
    surface_flux_function,
    equations::CompressibleEulerVectorInvariantEquations3D, combine_conservative_and_nonconservative_fluxes::True
)
...
@inline function Trixi.boundary_condition_slip_wall(
    ...
    equations::CompressibleEulerVectorInvariantEquations3D, combine_conservative_and_nonconservative_fluxes::False
)
...
@inline function flux_surface_combined(
    ...
    v_interface = 0.5f0 * (v_dot_n_ll + v_dot_n_rr) - 1 / (2 * c * rho_avg) * (p_rr - p_ll) * norm_
...
@inline Trixi.combine_conservative_and_nonconservative_fluxes(::typeof(flux_surface_combined), equations::CompressibleEulerVectorInvariantEquations3D) = Trixi.True()
