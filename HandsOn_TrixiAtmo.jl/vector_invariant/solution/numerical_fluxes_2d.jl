...
@inline Trixi.combine_conservative_and_nonconservative_fluxes(::typeof(flux_surface_combined_entropy_stable), equations::CompressibleEulerVectorInvariantEquations2D) = Trixi.True()
