...
vertical direction, vastly different spatial and time scales (that introduces a stiffnes in the system that must be handled)

Discontinuities are less of a concern, but we have interfaces or phase interfaces, that still needs a treatment similar to shocks.
