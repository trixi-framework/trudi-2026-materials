...
Each equation comes with: fluxes, initial conditions, boundary conditions, source terms, \texttt{cons2prim} et al, \texttt{max\_abs\_speeds} et al, ...

Equations: Compressible Euler considering different thermodynamic variables (total energy, kinetic plus internal, potential temperature, internal energy) and different form of the momentum equations, such as conservative or vector invariant form.
