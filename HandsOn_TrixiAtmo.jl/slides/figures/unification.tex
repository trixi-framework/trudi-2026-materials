...
\begin{tikzpicture}[
    ...
    \begin{scope}[
        ...
        \node[subtile] at ([xshift=-0.6cm, yshift=0.2cm]cartesian.north west)  {Dimension};
        \node[subtile] at ([xshift=-0.4cm, yshift=-1.0cm]cartesian.north west) {Microphysics};
        \node[subtile] at ([xshift=-0.4cm, yshift=0.2cm]cartesian.north east)  {Momentum\\equation};
        \node[subtile] (cartesian_par) at ([xshift=0.4cm, yshift=-0.2cm]cartesian.south west){Parameters};
        \node[subtile] at ([xshift=-0.4cm, yshift=-0.2cm]cartesian.south east) {Thermodynamic\\state};
        \node[subtile] at ([xshift=0.2cm, yshift=1.0cm]cartesian.south east) {Thermodynamic\\equation};
    \end{scope}
    ...
    \node[smalltile] (covariant_trafo_ic) at (-3.0, -5.5) {\small Transform i.c.};
    \node[smalltile] (covariant_trafo_st) at (-6.0, -5.5) {\small Transform s.t.};

    \node[smalltile] (cartesian_trafo_ic) at (6.0, -5.5) {\small Transform i.c.};
    \node[smalltile] (cartesian_trafo_st) at (3.0, -5.5) {\small Transform s.t.};
